                ...
                <ul>
                    <li class="dropdown"><div class="dropbtn">create content</div>
                        <div class="dropdown-content">
                            <a href="views/create-menu.php">Create User</a>
                            <a href="views/create-companypost.php">Create Post</a>
                            <a href="views/create-menu.php">Create Company</a>
                            <a href="views/create-staff.php">Create Staff</a>
                        </div>
                    </li>
